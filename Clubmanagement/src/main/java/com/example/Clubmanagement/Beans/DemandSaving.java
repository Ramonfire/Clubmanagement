...
public class DemandSaving {
    ...
    CommandLineRunner commandLineRunnerDemande(DemandeRepo demandeRepo) {
        ...
        CreationDemand d1 = new CreationDemand(null,Long.valueOf(5),"Club","testDemande1","testing",0);
        CreationDemand d2 = new CreationDemand(null,Long.valueOf(5),"Club","testDemande1","testing",0);
        CreationDemand d3 = new CreationDemand(null,Long.valueOf(5),"Club","testDemande1","testing",0);
