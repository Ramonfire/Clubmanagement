...
public class eventSaving {
    ...
    CommandLineRunner savingevents(EventRepo eventRepo, ClubRepo clubRepo){
        ...
        eventRepo.save( new evenement(null,"test1","testing1", 0,1,true,clubRepo.findByIdc(Long.valueOf(1)),null));
        eventRepo.save( new evenement(null,"test2","testing2", 0,1,false,clubRepo.findByIdc(Long.valueOf(2)),null));
        eventRepo.save( new evenement(null,"test3","testing3", 0,1,false,clubRepo.findByIdc(Long.valueOf(3)),null));
        eventRepo.save( new evenement(null,"test4","testing4", 0,-1,false,clubRepo.findByIdc(Long.valueOf(1)),null));
        return args -> {};
    }
}
